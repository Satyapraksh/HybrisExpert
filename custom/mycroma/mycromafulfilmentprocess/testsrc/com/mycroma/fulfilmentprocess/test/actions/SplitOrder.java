 ...
 */
package com.mycroma.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(MycromaFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MycromaFulfilmentProcessConstants.PARENT_PROCESS);
