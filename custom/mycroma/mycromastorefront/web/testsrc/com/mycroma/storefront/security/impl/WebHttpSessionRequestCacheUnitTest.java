...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mycromastorefront/electronics/en",
						"https://electronics.local:9002/mycromastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/mycromastorefront/electronics/en",
						"https://electronics.local:9002/mycromastorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mycromastorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/mycromastorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/mycromastorefront/electronics/en",
						"https://electronics.local:9002/mycromastorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mycromastorefront",
						"https://electronics.local:9002/mycromastorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/mycromastorefront",
						"https://electronics.local:9002/mycromastorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/mycromastorefront/electronics/en",
						"https://electronics.local:9002/mycromastorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
