 ...
 */
package com.mycroma.test.setup;
...
import com.mycroma.test.constants.MycromaTestConstants;
import com.mycroma.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = MycromaTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mycromatest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mycromatest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mycromatest/import/cstickets.impex");
			...
			importImpexFile(context, "/mycromatest/import/csquotes.impex");
		}
	}
}
