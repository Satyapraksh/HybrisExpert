 ...
 */
package com.mycroma.cockpits.setup;
...
import com.mycroma.cockpits.constants.MycromaCockpitsConstants;
 ...
 */
@SystemSetup(extension = MycromaCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MycromaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MycromaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MycromaCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mycromacockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
