 ...
 */
package com.mycroma.core.constants;

/**
 * Global class for all MycromaCore constants. You can add global constants for your extension into this class.
 */
public final class MycromaCoreConstants extends GeneratedMycromaCoreConstants
{
	public static final String EXTENSIONNAME = "mycromacore";


	private MycromaCoreConstants()
	{
		//empty
	}
